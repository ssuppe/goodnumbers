...
export default function AgreementsPage() {
  ...
  const [handleApiSubmit, isSubmitting, error] = useApiForm(
    async (data: { agreementsSigned: boolean }) => {
      await api.put("/user/settings", data);
      await refetchSession(); // <-- THE FIX: Refetch session state
      navigate("/setup");
    },
  );
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-xl shadow-lg p-8">
          <h1 className="text-3xl font-extrabold text-gray-900 text-center">
            Welcome to GoodNumbers
          </h1>
          <p className="mt-2 text-center text-gray-600">
            Before we can create your account, you must review and accept the
            agreements below.
          </p>
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-6">
              ...
              <div className="ml-3 text-sm leading-6">
                <label htmlFor="terms" className="text-gray-700 text-base">
                  ...
                  <strong className="font-bold">
                    GoodNumbers is an experimental project, is NOT medical
                    advice
                  </strong>
                  , and may provide incorrect or misleading information. I
                  confirm that I will{" "}
                  <strong className="font-bold">
                    always consult a healthcare professional
                  </strong>{" "}
                  before making any changes to my diabetic healthcare plan,
                  insulin usage, or device settings. I accept all responsibility
                  and liability for the use of this software.
                </label>
              </div>
            </div>
            ...
            <div className="relative flex items-start">
              ...
              <div className="ml-3 text-sm leading-6">
                <label htmlFor="privacy" className="text-gray-700 text-base">
                  ...
                  . I consent to the storage and processing of my pseudonymized
                  health data (including any treatment, CGM data, Nightscout
                  data, etc) for the purpose of journal analysis and feature
                  development. I understand I am responsible for the data I
                  share.
                </label>
              </div>
            </div>
            ...
            {error && (
              <div className="rounded-md bg-red-50 p-4">
                <div className="flex">
                  <div className="ml-3">
                    <p className="text-sm font-medium text-critical-red">
                      {error}
                    </p>
                  </div>
                </div>
