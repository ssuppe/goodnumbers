          ...
          <div className="space-y-6">
            ...
            <div>
              <button
                ...
                className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-mesa-primary hover:bg-primary-hover disabled:bg-gray-400"
              >
