...
describe("AgreementsPage", () => {
  ...
  it("renders all required text, checkboxes, and a disabled button", async () => {
    ...
    const privacyCheckbox = screen.getByLabelText(
      /i have read and accept the privacy policy/i,
    );
    ...
    const continueButton = screen.getByRole("button", {
      name: /Accept and Continue to Setup/i,
    });
  ...
  it("calls the api submission hook with correct data when submitted", async () => {
    ...
    fireEvent.click(
      screen.getByLabelText(/i have read and accept the privacy policy/i),
    );

    // Click the button and verify our specific submission handler was called
    fireEvent.click(
      screen.getByRole("button", { name: /Accept and Continue to Setup/i }),
    );
