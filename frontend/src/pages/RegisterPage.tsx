...
export default function RegisterPage() {
  ...
  return (
    <div className="max-w-md mx-auto mt-16 p-6 bg-white rounded-lg shadow-sm border border-mesa-border">
      ...
      <p className="text-sm text-mesa-muted mb-6 text-center">
        Only emails on the allowlist can register.
      </p>
      ...
      <p className="mt-4 text-center text-sm text-mesa-muted">
        ...
        <Link to="/login" className="text-mesa-primary hover:underline">
          Log in here
        </Link>
      </p>
    </div>
