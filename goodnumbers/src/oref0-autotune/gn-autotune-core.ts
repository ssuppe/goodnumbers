...
Original license, before my modifications. My modifications are not covered by
this license.
...
//     .usage(
//       '$0 <autotune/glucose.json> <autotune/autotune.json> <settings/profile.json> [--output-file=<output_file.json>]',
//     )
//     .option('output-file', {
//       alias: 'o',
...
export const gn_autotune_core = (
  prepped_glucose_data: any,
  previous_autotune_data: ATProfileSettings,
  ...
  // GN: Assuming no custom peak time
  ...
  // Always keep the curve value up to date with what's in the user
  // GN: Assuming no custom curve
