...
import tidelineBlip from '../../../lib/tideline/plugins/blip';
...
const DailyChart = withTranslation(null, { withRef: true })(
  class DailyChart extends Component {
    ...
    mountChart = (props = this.props) => {
      ...
      this.chart = chartDailyFactory(node, _.pick(props, this.chartOpts)).setupPools();
      this.bindEvents();
    };
...
class Daily extends Component {
  ...
  renderChart = () => {
    ...
    const { isAutomatedBasalDevice, isAutomatedBolusDevice } = _.get(this.props, 'data.metaData.latestPumpUpload', {});

    const hasCarbExchanges = _.some(_.get(this.props, 'data.data.combined'), {
      type: 'wizard',
      carbUnits: 'exchanges',
    });
