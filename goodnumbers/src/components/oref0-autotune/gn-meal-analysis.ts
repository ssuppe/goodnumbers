...
class GlucoseAnalysis {
  ...
  getPercentages(): PercentageResults {
    return {
      ...
      inRangePercentage:
        ((this.stateCounts[GlucoseState.IN_RANGE] + this.stateCounts[GlucoseState.IN_TITR]) / this.numReadings) * 100,
      inTargetPercentage: (this.stateCounts[GlucoseState.IN_TARGET] / this.numReadings) * 100,
      inTITRPercentage: (this.stateCounts[GlucoseState.IN_TITR] / this.numReadings) * 100,
