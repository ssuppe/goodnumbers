  ...
  describe('calculateMetrics', () => {
    ...
    it('should calculate stability correctly (ROC < 1.5)', () => {
      ...
      const entries: GlucoseEntry[] = [
        ...
        }, // +5 mins, diff=5, ROC=1 (Stable)
        {
          sgv: 120,
          date: baseTime + 10 * 60 * 1000,
          dateString: new Date(baseTime + 10 * 60 * 1000).toISOString(),
        }, // +5 mins from prev, diff=15, ROC=3 (Unstable)
      ];
      // Total intervals: 2. Stable: 1. Stability: 50%.
      const result = calculateMetrics(entries);
    ...
    it('should calculate averages and ranges correctly', () => {
      const entries: GlucoseEntry[] = [
        ...
        { sgv: 200, date: 3, dateString: '' }, // Out range
        { sgv: 50, date: 4, dateString: '' }, // Out range
      ];
      // Avg: 500 / 4 = 125
      // TIR: 2/4 = 50%
      // TITR: 1/4 = 25%
