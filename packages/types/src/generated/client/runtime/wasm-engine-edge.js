...
var je = class extends Te {
  ...
  writeWithItems(e) {
    ...
    (e
      .writeLine("[")
      .withIndent(() => e.writeJoined($e, this.items).newLine())
      .write("]"),
      this.hasError &&
        e.afterNextNewline(() => {
...
var Qe = class t extends Te {
  ...
  writeWithContents(e, r) {
    (e.writeLine("{").withIndent(() => {
      e.writeJoined($e, [...r, ...this.suggestions]).newLine();
    }),
      e.write("}"),
      this.hasError &&
        e.afterNextNewline(() => {
...
function Si(t, e) {
  ...
  if (qe(t)) {
    if ($t(t)) return { $type: "DateTime", value: t.toISOString() };
