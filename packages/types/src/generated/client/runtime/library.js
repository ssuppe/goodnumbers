...
var zt = globalThis.window?.document !== void 0,
  ...
  bg = globalThis.navigator?.userAgent?.includes("jsdom") === !0,
  wg =
...
var Pr = 9e15,
  ...
  qs = bn + "Precision limit exceeded",
  Vs = bn + "crypto unavailable",
  js = "[object Decimal]",
  X = Math.floor,
  U = Math.pow,
...
function J(e) {
  ...
  if (i > 0) {
    for (o += s, r = 1; r < i; r++)
      ((n = e[r] + ""), (t = b - n.length), t && (o += Je(t)), (o += n));
            ...
            u < 0
              ? ((me = E[0]),
                ...
                u == -1 &&
                  ((D = E.length),
                  (u = r(k, E, K, D)),
                  u < 1 && (d++, t(E, K < D ? fr : k, D, l))),
                (D = E.length))
              : u === 0 && (d++, (E = [0])),
            (S[p++] = d),
            u && E[0] ? (E[D++] = H[j] || 0) : ((E = [H[j]]), (D = 1)));
...
function Ke(e, r) {
  ...
  if (
    ...
    return (
      (u = En(T, c + 2, E).times(o + "")),
      (g = Ke(new T(n + "." + t.slice(1)), c - h).plus(u)),
      (T.precision = E),
      r == null ? y(g, E, S, (w = !0)) : g
    );
  for (
    p = g,
    ...
    if (
      ...
      if (
        ((l = l.times(2)),
        o !== 0 && (l = l.plus(En(T, c + 2, E).times(o + ""))),
        (l = L(l, new T(f), c, 1)),
        r == null)
      )
        if (ut(l.d, c - h, S, a))
      ...
      for (let g in t) {
        ...
        for (let T = 0; T < I.length; ++T) {
          ...
          for (let j = n, te = i; j < r.length; te += r[j].length, ++j) {
            ...
            let fr = new ge(g, E ? v.tokenize(p, E) : p, Kr, p, me);
            if (
              (K.push(fr),
              h && K.push(h),
...
var Ln = class {
    ...
    getAllComputedFields(r) {
      return this.computedFieldsCache.getOrCreate(r, () =>
        Ea(this.previous?.getAllComputedFields(r), this.extension, r),
      );
    }
