...
2. Interaction Flow
  ...
  3. **Allowlist Check:** The system checks if the user's email is in the allowlist.
  4. **Allowed:** The user proceeds to the Agreements or Dashboard page.
  5. **Denied:** The sign-in fails, and the user is denied access.
...
- **Influencing Factors:** Multi-select chips organized by category:
  ...
  - **Movement:** Strenuous Exercise, Sedentary.
